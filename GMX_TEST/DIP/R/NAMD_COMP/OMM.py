...
ala5_gas =  load_file('test_autopsf.psf')
ala5_crds = load_file('test_autopsf.pdb')

# Create the OpenMM system
print('Creating OpenMM System')
system = ala5_gas.createSystem(params, nonbondedMethod=app.NoCutoff,nonbondedCutoff=1000.0*u.angstroms)
...
struct=pmd.load_file('test_autopsf.pdb')
